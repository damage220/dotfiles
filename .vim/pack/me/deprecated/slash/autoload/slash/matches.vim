function! slash#matches#index(pattern, ...)
	let options = get(a:, 1, {})
	...
	for line in lines
		let matchesInString = slash#getStringMatches(line, a:pattern, offsetType)
		let lineNumber += 1
	...
	if(len(items) == 0)
		return slash#error("No matches were found.")
	endif
